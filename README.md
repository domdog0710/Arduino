...
<root>
  ...
  ├── Editor
  │   ├── Cmieadobe.Arduino.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Cmieadobe.Arduino.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Cmieadobe.Arduino.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Cmieadobe.Arduino.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Cmieadobe.Arduino`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Arduino Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Cmieadobe.Arduino.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Cmieadobe.Arduino.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Cmieadobe.Arduino.Editor.Tests.asmdef`

  `Tests/Runtime/Cmieadobe.Arduino.Tests.asmdef`
...
Use the `Documentations~/Arduino.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
